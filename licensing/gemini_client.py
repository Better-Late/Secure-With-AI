...
def generate_content(prompt: str, model: str = 'gemini-2.5-flash-lite') -> Optional[str]:
    """
...
def generate_content_with_search(prompt: str, model: str = 'gemini-2.0-flash-lite') -> Optional[str]:
    """
...
def summarize_legal_text(text: str, page_url: str, max_chars: int = 1000, model: str = 'gemini-2.0-flash-lite') -> Optional[str]:
    """
